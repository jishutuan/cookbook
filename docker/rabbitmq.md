...
docker run -d -p 5672:5672 -p 15672:15672 -p 1883:1883 -p 15675:15675 \
-e RABBITMQ_DEFAULT_USER=admin -e RABBITMQ_DEFAULT_PASS=q1w2e3r4 \
--name rabbit rabbitmq:3.7.8-management-alpine
...
<script type="text/javascript">
  ...
  var password = CryptoJS.HmacSHA1(groupId, secretKey).toString(
    CryptoJS.enc.Base64
  );
